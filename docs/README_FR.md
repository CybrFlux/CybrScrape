...
> Tous les benchmarks représentent des moyennes de plus de 100 exécutions. Voir [benchmarks.py](https://github.com/CybrFlux/CybrScrape/blob/main/benchmarks.py) pour la méthodologie.
...
Les contributions sont les bienvenues ! Veuillez lire nos [directives de contribution](https://github.com/CybrFlux/CybrScrape/blob/main/CONTRIBUTING.md) avant de commencer.
...
- Parsel (Licence BSD) — Utilisé pour le sous-module [translator](https://github.com/CybrFlux/CybrScrape/blob/main/scrapling/core/translator.py)
