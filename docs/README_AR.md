...
> تمثل جميع المعايير متوسطات أكثر من 100 تشغيل. انظر [benchmarks.py](https://github.com/CybrFlux/CybrScrape/blob/main/benchmarks.py) للمنهجية.
...
نرحب بالمساهمات! يرجى قراءة [إرشادات المساهمة](https://github.com/CybrFlux/CybrScrape/blob/main/CONTRIBUTING.md) قبل البدء.
...
- Parsel (ترخيص BSD) — يُستخدم للوحدة الفرعية [translator](https://github.com/CybrFlux/CybrScrape/blob/main/scrapling/core/translator.py)
