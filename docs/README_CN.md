...
> 所有基准测试代表 100+ 次运行的平均值。请参阅 [benchmarks.py](https://github.com/CybrFlux/CybrScrape/blob/main/benchmarks.py) 了解方法。
...
我们欢迎贡献！在开始之前，请阅读我们的 [贡献指南](https://github.com/CybrFlux/CybrScrape/blob/main/CONTRIBUTING.md)。
...
此项目包含改编自以下内容的代码：
- Parsel（BSD 许可证）——用于 [translator](https://github.com/CybrFlux/CybrScrape/blob/main/scrapling/core/translator.py)子模块
