...
> 모든 벤치마크는 100회 이상 실행의 평균입니다. 측정 방법은 [benchmarks.py](https://github.com/CybrFlux/CybrScrape/blob/main/benchmarks.py)를 참조하세요.
...
기여를 환영합니다! 시작하기 전에 [기여 가이드라인](https://github.com/CybrFlux/CybrScrape/blob/main/CONTRIBUTING.md)을 읽어주세요.
...
- Parsel (BSD 라이선스) — [translator](https://github.com/CybrFlux/CybrScrape/blob/main/scrapling/core/translator.py) 서브모듈에 사용
