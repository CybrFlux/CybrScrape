...
> すべてのベンチマークは 100 回以上の実行の平均を表します。方法論については[benchmarks.py](https://github.com/CybrFlux/CybrScrape/blob/main/benchmarks.py)を参照してください。
...
貢献を歓迎します！始める前に[貢献ガイドライン](https://github.com/CybrFlux/CybrScrape/blob/main/CONTRIBUTING.md)をお読みください。
...
- Parsel（BSD ライセンス）— [translator](https://github.com/CybrFlux/CybrScrape/blob/main/scrapling/core/translator.py) サブモジュールに使用
